...
```sh
$ cp -r app/modular-tiles-launcher/target/plugins-prepared/tile-* plugins
```
...
```sh
$ cp -r app/modular-tiles-launcher/build/plugins-prepared/tile-* app/modular-tiles-launcher/plugins
```
